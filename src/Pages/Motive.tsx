...
export default function Motive() {
  ...
  return (
    <main className="relative min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-zinc-950 to-gray-900 text-white font-sans overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-80 h-80 bg-red-600 opacity-20 rounded-full blur-3xl -z-10 animate-pulse" style={{ top: '-5rem', left: '-5rem' }} />
      <div className="absolute bottom-0 right-0 w-72 h-72 bg-red-800 opacity-10 rounded-full blur-2xl -z-10 animate-pulse" style={{ bottom: '-3rem', right: '-3rem' }} />
      <section className="text-center px-6 py-10 max-w-2xl mx-auto">
        ...
        <p className="text-lg md:text-xl text-gray-300 mb-8 leading-relaxed">
          LocaFindr aims to empower communities by making it easy to discover local businesses, services, and hidden gems.<br className="hidden md:block" />
          <span className="block mt-2">We believe in supporting local economies and helping people connect with what matters most, right where they live.</span>
        </p>
        <button
